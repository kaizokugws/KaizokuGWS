  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-bold mb-8 text-[#E6EDF3]">Privacy Policy</h1>
        
        <div className="space-y-8">
          <section className="bg-[#111418] rounded-xl p-6 border border-[#222]">
            <h2 className="text-xl font-bold mb-4 text-[#E6EDF3]">Data Collection</h2>
          ...
          <section className="bg-[#111418] rounded-xl p-6 border border-[#222]">
            <h2 className="text-xl font-bold mb-4 text-[#E6EDF3]">Cookies</h2>
            <p className="text-[#9AA4AF] leading-relaxed">
          ...
          <section className="bg-[#111418] rounded-xl p-6 border border-[#222]">
            <h2 className="text-xl font-bold mb-4 text-[#E6EDF3]">Third-Party Services</h2>
            <p className="text-[#9AA4AF] leading-relaxed">
          ...
          <section className="bg-[#111418] rounded-xl p-6 border border-[#222]">
            <h2 className="text-xl font-bold mb-4 text-[#E6EDF3]">Changes to Policy</h2>
            <p className="text-[#9AA4AF] leading-relaxed">
          ...
          <section className="bg-[#111418] rounded-xl p-6 border border-[#222]">
            <h2 className="text-xl font-bold mb-4 text-[#E6EDF3]">Contact</h2>
            <p className="text-[#9AA4AF] leading-relaxed">
